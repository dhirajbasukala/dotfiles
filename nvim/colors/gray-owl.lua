-- gray-owl.nvim
-- Night Owl variant with dark gray background instead of dark blue
-- Drop into ~/.config/nvim/colors/gray-owl.lua
...
-- Shifted to dark gray equivalents:
local c = {
  bg = "#1a1a1a", -- main background (was #011627)
  bg_dark = "#111111", -- darker panels / sidebars (was #01111d)
  bg_lighter = "#252525", -- float / popup bg (was #0b2942)
  bg_highlight = "#2e2e2e", -- cursorline, visual (was #1d3b53)
  bg_visual = "#3a3a3a", -- visual selection (was #1d3b53)
  border = "#3c3c3c", -- borders / window separators
